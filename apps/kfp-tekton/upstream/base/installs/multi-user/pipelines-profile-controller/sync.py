...
def get_settings_from_env(controller_port=None,
    ...
    settings["visualization_server_image"] = \
        ...
        os.environ.get("VISUALIZATION_SERVER_IMAGE", "uhub.service.ucloud.cn/mirrors/visualization-server")

    settings["frontend_image"] = \
        frontend_image or \
        os.environ.get("FRONTEND_IMAGE", "uhub.service.ucloud.cn/mirrors/frontend")
